...
beautiful.init("/home/roos/.config/awesome/default/theme.lua")
--beautiful.init("/home/roos/.config/awesome/xresources/theme.lua")
local bling = require("bling")
local bling_launcher = bling.widget.app_launcher()
local fancy_taglist = require("bars/fancy_taglist")
...
awful.screen.connect_for_each_screen(function(s)
   ...
   --[[s.mytaglist = awful.widget.taglist {
    ...
    require("crylia_bar.left_bar")(s, { logout_menu_widget(),s.mytaglist})
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () os.execute("~/.config/rofi/launchers/type-3/launcher.sh") end,--bling_launcher:toggle() end,--awful.screen.focused().mypromptbox:run() end,
