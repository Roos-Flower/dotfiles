...
local function worker(user_args)
    ...
    local warning_msg_title = args.warning_msg_title or 'Plug that shit in dog'
    ...
    local function show_battery_warning()
        local sillyFontSize = (sillyX/10)-20
        naughty.notify {
            icon = warning_msg_icon,
            icon_size = 100,
            font =  "sans " .. tostring(sillyFontSize),
    ...
    local function update_widget(widget, stdout)
        ...
        widget.value = charge
        batteryarc_widget.start_angle=4.71238898-((charge/batteryarc_widget.max_value)*6.28)
